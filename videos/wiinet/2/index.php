...
<body>
        <div style="text-align:center;">
            ...
            <object type="application/x-shockwave-flash" data="../../resources/player.swf" width="384" height="256">
                ...
                <param name='flashvars' value='filename=Doger.net-2-1.flv'>
            </object>
			</div>
            PART 1 - <a href="index2.html">PART 2</a>
            <h1>What's next for Doger.net? - Project update (June 2023)</h1>
        ...
        <table>
            <tr>
				...
				<td style="padding-left:20px;">
					<h2>Description</h2>
					soafen and Turtle discuss the current progress with Doger.net and future plans for the project, along with how you can help out!
				</td>
            </tr>
            </table>
    </body>
